    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'contextual.log' => \App\Services\ContextualLogService::class,
    ...
    override(\config(), map([
            ...
            'app.tenant_base_domain' => 'string',
            'attachments.debug_log' => 'boolean',
            'attachments.self_heal' => 'boolean',
            ...
            'database.connections.central.driver' => 'string',
            'database.connections.central.url' => 'NULL',
            'database.connections.central.host' => 'string',
            'database.connections.central.port' => 'string',
            'database.connections.central.database' => 'string',
            'database.connections.central.username' => 'string',
            'database.connections.central.password' => 'string',
            'database.connections.central.unix_socket' => 'string',
            'database.connections.central.charset' => 'string',
            'database.connections.central.collation' => 'string',
            'database.connections.central.prefix' => 'string',
            'database.connections.central.prefix_indexes' => 'boolean',
            'database.connections.central.strict' => 'boolean',
            'database.connections.central.engine' => 'NULL',
            'database.connections.central.options' => 'array',
            ...
            'filesystems.links./Users/satoushouta/Projects/CommuniCareV2/src/public/storage' => 'string',
            'guest.domains.local' => 'string',
            'guest.domains.staging' => 'string',
            'guest.domains.production' => 'string',
            'guest.protocol' => 'string',
            'guest.ports.local' => 'integer',
            'guest.ports.staging' => 'NULL',
            'guest.ports.production' => 'NULL',
            ...
            'logging.channels.web.driver' => 'string',
            'logging.channels.web.path' => 'string',
            'logging.channels.web.level' => 'string',
            'logging.channels.web.days' => 'integer',
            'logging.channels.web.replace_placeholders' => 'boolean',
            'logging.channels.guest.driver' => 'string',
            'logging.channels.guest.path' => 'string',
            'logging.channels.guest.level' => 'string',
            'logging.channels.guest.days' => 'integer',
            'logging.channels.guest.replace_placeholders' => 'boolean',
            'logging.channels.admin.driver' => 'string',
            'logging.channels.admin.path' => 'string',
            'logging.channels.admin.level' => 'string',
            'logging.channels.admin.days' => 'integer',
            'logging.channels.admin.replace_placeholders' => 'boolean',
            'logging.channels.console.driver' => 'string',
            'logging.channels.console.path' => 'string',
            'logging.channels.console.level' => 'string',
            'logging.channels.console.days' => 'integer',
            'logging.channels.console.replace_placeholders' => 'boolean',
            'logging.contextual_channels' => 'string',
            'mail.default' => 'string',
            ...
            'tenancy.domain_suffix.local' => 'string',
            'tenancy.domain_suffix.production' => 'string',
            'tenancy.domain_suffix.staging' => 'string',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.tenant_base_domain',
'attachments.debug_log','attachments.self_heal','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'database.connections.central.driver','database.connections.central.url','database.connections.central.host','database.connections.central.port','database.connections.central.database',
'database.connections.central.username','database.connections.central.password','database.connections.central.unix_socket','database.connections.central.charset','database.connections.central.collation',
'database.connections.central.prefix','database.connections.central.prefix_indexes','database.connections.central.strict','database.connections.central.engine','database.connections.central.options',
...
'debugbar.options.auth.show_guards','debugbar.options.db.with_params','debugbar.options.db.backtrace','debugbar.options.db.backtrace_exclude_paths','debugbar.options.db.timeline',
...
'filesystems.links./Users/satoushouta/Projects/CommuniCareV2/src/public/storage','guest.domains.local','guest.domains.staging','guest.domains.production','guest.protocol',
'guest.ports.local','guest.ports.staging','guest.ports.production','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.web.driver','logging.channels.web.path','logging.channels.web.level',
'logging.channels.web.days','logging.channels.web.replace_placeholders','logging.channels.guest.driver','logging.channels.guest.path','logging.channels.guest.level',
'logging.channels.guest.days','logging.channels.guest.replace_placeholders','logging.channels.admin.driver','logging.channels.admin.path','logging.channels.admin.level',
'logging.channels.admin.days','logging.channels.admin.replace_placeholders','logging.channels.console.driver','logging.channels.console.path','logging.channels.console.level',
'logging.channels.console.days','logging.channels.console.replace_placeholders','logging.contextual_channels','mail.default','mail.mailers.smtp.transport',
...
'tenancy.domain_suffix.local','tenancy.domain_suffix.production','tenancy.domain_suffix.staging','inertia.ssr.enabled','inertia.ssr.url',
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','ide-helper.filename','ide-helper.models_filename',
...
'welcome','dashboard','profile.updateIcon','profile.edit','profile.update',
'profile.destroy','users.index','users.create','users.store',
'users.show','users.edit','users.update','users.destroy','users.editProfile',
'users.editIcon','users.updateIcon','units.index','units.create','units.store',
'units.show','units.edit','units.update','units.destroy','residents.index',
'residents.create','residents.store','residents.show','residents.edit','residents.update',
'residents.destroy','admin.transferAdmin','units.sort','legal.privacyPolicy','legal.termsOfService',
'register','register.post','login','guest.login.redirect',
'register-admin.form','register-admin','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','logout-guest','guest.login.view','guest.user.login','attachments.show','attachments.destroy','forum.index',
'forum.store','forum.destroy','forum.post.attachments.add','forum.post.attachments.remove','like.toggle',
'comment.store','comment.destroy','forum.comment.attachments.add','forum.comment.attachments.remove','calendar.index',
'calendar.week','calendar.day','calendar.schedules.index','calendar.schedule.store','calendar.schedule.update',
'calendar.schedule.destroy',);
...
'validation.custom.attribute-name.rule-name','messages.user_not_in_unit','messages.forum_not_found','validation.custom.属性名.ルール名','validation.custom.terms.required',
'validation.custom.tenant_domain_id.correct','validation.custom.business_name.exists','validation.attributes.address','validation.attributes.age','validation.attributes.amount',
...
'validation.attributes.photo','validation.attributes.postal_code','validation.attributes.prefecture','validation.attributes.price','validation.attributes.province',
...
'validation.attributes.title','validation.attributes.updated_at','validation.attributes.username','validation.attributes.year','validation.attributes.business_name',
'validation.attributes.tenant_domain_id','validation.attributes.icon','validation.attributes.username_id','validation.attributes.unit_id',);
...
'SESSION_SAME_SITE','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE',
...
'VITE_GUEST_TENANT_URL','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_NO_ANALYTICS','TENANT_DOMAIN_ID',
'TENANT_BASE_DOMAIN','GUEST_DOMAIN_LOCAL','GUEST_DOMAIN_STAGING','GUEST_DOMAIN_PRODUCTION',);
