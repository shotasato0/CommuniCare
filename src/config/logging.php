...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Contextual Log Channels (ContextualLogService)
    |--------------------------------------------------------------------------
    |
    | コンテキストに応じたログチャンネル選択で利用するチャンネル一覧。
    | カンマ区切りで指定（例: "web,guest,admin,console"）。
    | config:cache 環境でも正しく動作するよう config 経由で読み込みます。
    |
    */

    'contextual_channels' => env('LOG_CHANNELS', 'web,guest,admin,console'),
