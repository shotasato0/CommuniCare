...
| 左サイドバー                                                                                                                                     | 右サイドバー                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **部署一覧が表示され、現在の掲示板の部署名がグレーでハイライトされる。掲示板にアクセスすると、自身の所属する部署の掲示板が自動的に表示される。** | **現在表示中の掲示板に対応する部署の職員名が一覧で表示される。職員名やアイコンをクリックすると、その職員の詳細情報をモーダルウィンドウで確認可能。** |
| ![左サイドバー](public/images/feature_sidebar_left.png)                                                                                          | ![職員詳細モーダル](public/images/feature_users_datail_modal.png)                                                                                    |
