...
-   **掲示板機能:** 全体連絡や部署間での申し送りなどのやり取りが可能。メイン機能として活躍。
    ...
    -   **いいね機能:** 投稿に対してリアクションが可能で、投稿や返信の既読のサインとして活用可能。

    <div align="center">
        <img src="public/images/feature_forum_page.png" width="45%">
    </div>

    -   **左サイドバーの機能:**  
        左側のサイドバーには **部署一覧** が表示されており、  
        現在表示中の掲示板に対応する部署名は **グレーでハイライト** されます。  
        掲示板にアクセスすると、自身の所属する部署の掲示板が自動的に表示される仕様になっており、  
        他の部署の掲示板へはサイドバーの部署一覧から切り替えることが可能です。

    -   **右サイドバーの機能:**  
        現在表示中の掲示板に **対応する部署の職員名** が一覧で表示されます。  
        **職員名やアイコン部分をクリック** すると、その職員の詳細情報を **モーダルウィンドウ** で確認できます。

    <div align="center">
        <img src="public/images/feature_users_datail_modal.png" width="45%">
    </div>
...
-   **職員ページ機能:**  
    ...
    **職員名をクリックすると、その職員の詳細情報をモーダルウィンドウで確認可能。**  
    ...
    <div align="center">
        <img src="public/images/feature_users_page.png" width="45%">
    </div>

---

-   **利用者ページ機能:**  
    利用者の一覧を表示し、部署ごとに絞り込んで閲覧が可能。  
    **利用者名をクリックすると、詳細情報ページが表示されます。**  
    サービス内容、支援状況、備考などの利用者情報の確認や編集が可能。  
    また、管理者は利用者の登録・削除が可能。

    <div align="center">
        <img src="public/images/feature_residents_page.png" width="50%">
        <img src="public/images/feature_residents_detail.png" width="50%">
    </div>

---

-   **管理ページ:**  
    ログイン中のユーザー情報とログイン状態を表示。管理者は部署管理（新規登録・削除）が可能。
